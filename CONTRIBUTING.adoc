...
hyperpolymath/ ├── src/ # Source code (Perimeter 1-2) ├── lib/ # Library
...
channel definition (Perimeter 1) ├── guix.scm # Guix manifest (Perimeter
1) └── Justfile # Task runner (Perimeter 1)
