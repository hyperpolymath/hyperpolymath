...
moment (_synchronic_), and which commitments survive its transformations over
time (_diachronic_)? This connects the equivalence work to the continuity of
...
Lean.
* https://github.com/hyperpolymath/firmboot[*Firmboot*] — continuity through
...
* https://github.com/hyperpolymath/quandledb[*QuandleDB*] — algebraic fingerprinting using quandle invariants.
* Alongside it, https://github.com/hyperpolymath/lithoglyphdb[*LithoglyphDB*], https://github.com/hyperpolymath/verisimdb[*VeriSimDB*], https://github.com/hyperpolymath/glyphbase[*Glyphbase*], and
...
https://github.com/hyperpolymath/manifesto[manifesto] explains the estate's
purpose; the
https://github.com/hyperpolymath/standards/tree/main/constitution[estate
constitution] states what may govern; the
https://github.com/hyperpolymath/standards/tree/main/catalogue[standards
catalogue] routes readers to applicable standards; and the
https://github.com/hyperpolymath/standards/blob/main/constitution/KNOWN-TENSIONS.adoc[known-tensions
register] records unresolved contradictions, architectural tensions, debt,
