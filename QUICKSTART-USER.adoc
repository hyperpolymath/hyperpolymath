...
// Replace hyperpolymath, Hyperpolymath — See README.adoc for details., just run, Hyperpolymath started successfully. with actuals
= hyperpolymath — Quick Start for Users
:toc:
:toclevels: 2

== What is hyperpolymath?

Hyperpolymath — See README.adoc for details.
...
[source,bash]
----
just install --portable --prefix=./hyperpolymath-portable
----
...
[source]
----
Hyperpolymath started successfully.
----
...
* **Wiki**: https://github.com/hyperpolymath/hyperpolymath/wiki
