...
// Replace hyperpolymath, hyperpolymath, {{DEPS}} with actuals
= hyperpolymath — Quick Start for Platform Maintainers
:toc:
:toclevels: 2

== Overview

This guide covers packaging, deploying, and maintaining hyperpolymath for
...
| `$PREFIX/share/hyperpolymath/`
| Data files, assets

| `$PREFIX/share/doc/hyperpolymath/`
| Documentation
...
Default config location: `$XDG_CONFIG_HOME/hyperpolymath/config.toml`

Fallback: `$HOME/.config/hyperpolymath/config.toml`
...
Or via OPSM: `opsm update hyperpolymath`
...
[source,bash]
----
just install --prefix=/opt/hyperpolymath-instance1 --config=/etc/hyperpolymath/instance1.toml
just install --prefix=/opt/hyperpolymath-instance2 --config=/etc/hyperpolymath/instance2.toml
----
...
* Upstream: https://github.com/hyperpolymath/hyperpolymath/issues
