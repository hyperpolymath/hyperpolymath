...
git clone <https://github.com/hyperpolymath/hyperpolymath.git> cd
hyperpolymath
...
toolbox create hyperpolymath-dev toolbox enter hyperpolymath-dev \#
...
hyperpolymath/ ├── src/ \# Source code (Perimeter 1-2) ├── lib/ \#
...
MAINTAINERS.md ├── README.adoc ├── SECURITY.md ├── .guix-channel \# Guix
channel definition (Perimeter 1) ├── guix.scm \# Guix manifest
(Perimeter 1) └── Justfile \# Task runner (Perimeter 1)
    ...
    **When suggesting**:
    ...
    - [`good first issue`](https://github.com/hyperpolymath/hyperpolymath/labels/good%20first%20issue) — Simple Perimeter 3 tasks
    - [`help wanted`](https://github.com/hyperpolymath/hyperpolymath/labels/help%20wanted) — Community help needed
    - [`documentation`](https://github.com/hyperpolymath/hyperpolymath/labels/documentation) — Docs improvements
    - [`perimeter-3`](https://github.com/hyperpolymath/hyperpolymath/labels/perimeter-3) — Community sandbox scope
