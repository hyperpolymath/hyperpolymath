...
This project is licensed under the **Palimpsest-MPL License 1.0 (PMPL-1.0-or-later)**.
For SPDX and tooling, use **PMPL-1.0-or-later**.

PMPL-1.0-or-later incorporates the Mozilla Public License 2.0 by reference and adds
...
The current legal text is PMPL-1.0-or-later.
